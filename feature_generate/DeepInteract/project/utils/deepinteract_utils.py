...
def process_pdb_into_graph(left_pdb_filepath: str, right_pdb_filepath: str, input_dataset_dir: str, psaia_dir: str,
    ...
    # with open("/data/user/zhouxl/Workspace/DeepInteract/test/df1.pkl", "wb") as f:
    #     pickle.dump(input_pair.df0, f)
    # with open("/data/user/zhouxl/Workspace/DeepInteract/test/df2.pkl", "wb") as f:
    #     pickle.dump(input_pair.df1, f)
