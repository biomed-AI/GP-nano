...
from datasets.CASP_CAPRI.casp_capri_dgl_dataset import CASPCAPRIDGLDataset
from datasets.DB5.db5_dgl_dataset import DB5DGLDataset
from datasets.DIPS.dips_dgl_dataset import DIPSDGLDataset
